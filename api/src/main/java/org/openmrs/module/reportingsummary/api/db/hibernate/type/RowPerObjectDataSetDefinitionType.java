...
package org.openmrs.module.reportingsummary.api.db.hibernate.type;
...
public class RowPerObjectDataSetDefinitionType implements UserType {

    private static final Log log = LogFactory.getLog(RowPerObjectDataSetDefinitionType.class);
    ...
    public Class returnedClass() {
        return RowPerObjectDataSetDefinition.class;
    }
    ...
    public void nullSafeSet(final PreparedStatement preparedStatement, final Object value, final int index) throws HibernateException, SQLException {
        RowPerObjectDataSetDefinition definition = (RowPerObjectDataSetDefinition) value;
    ...
    public Serializable disassemble(final Object value) throws HibernateException {
        if (value == null)
            return null;
        return ((RowPerObjectDataSetDefinition) value).getUuid();
    }
